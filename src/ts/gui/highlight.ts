...
const ensureHighlightStyle = () => {
    ...
    style.textContent = `
::highlight(cbsnest0) { color: var(--color-syntax-keyword); }
::highlight(cbsnest1) { color: var(--color-syntax-type); }
::highlight(cbsnest2) { color: var(--color-syntax-literal); }
::highlight(cbsnest3) { color: var(--color-syntax-variable); }
::highlight(cbsnest4) { color: var(--color-syntax-keyword); }
