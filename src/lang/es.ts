...
export const languageSpanish = {
    ...
    "errors": {
        ...
        "networkFetchWeb": "Esto puede ser un error de CORS. Esto solo ocurre al usar la versión web debido a las limitaciones del navegador. Intenta usar la versión local de escritorio u otra versión de PocketRisu Kei.",
    ...
    "setup": {
        ...
        "welcome": "¡Bienvenido a PocketRisu Kei! Aquí te guiaré para configurarlo. Primero, ¿cómo puedo llamarte?",
    ...
    "inlayGallery": {
        ...
        "inlayImageGallery": "Galería Inlay",
        "inlayImageGalleryEmptyDesc": "Las imágenes adjuntas o generadas en chats aparecerán aquí",
        "inlayMediaList": "Lista de vídeo/audio",
        "inlayMediaGalleryEmptyDesc": "Los vídeos y audios adjuntos en chats aparecerán aquí",
        "inlayMissing": "Recurso inlay no encontrado",
        ...
        "inlayFilter": "Filter",
        "inlayFilterAll": "All",
        "inlayFilterMetaMissing": "Sin vínculo con el chat",
    ...
    "unformatQuotes": "Activar Formato de Citas",
    ...
    "pluginVersionWarn": "Esta es la versión {{plugin_version}} del plugin, que no es compatible con esta versión de PocketRisu Kei. Por favor, actualiza el plugin a la versión {{required_version}}.",
    ...
    "hotkeyDesc": {
        ...
        "settings": "Configuración",
        "home": "Inicio",
        "presets": "Vinculación de prompt",
        "persona": "Vinculación de persona",
        "modelSelect": "Vinculación de modelo",
        ...
        "toggleLog": "Registro de solicitudes",
    ...
    "pluginRiskDetectedAlert": "PocketRisu Kei detectó código que puede ser dañino y que podría ROBAR TU CLAVE API O DATOS PERSONALES. te recomendamos NO INSTALAR ESTE PLUGIN.",
    "doNotInstall": "No Instalar",
    "continueAnyway": "Continuar de Todos Modos",
    "pluginNoRiskButAlert": "PocketRisu Kei no detectó código dañino, pero ten en cuenta que instalar plugins de fuentes no confiables puede plantear riesgos de seguridad.",
    ...
    "inlayPermissionConsent": "El plugin {} está solicitando permiso para acceder a los recursos inlay, lo que podría exponer archivos adjuntos a los chats. ¿Desea permitir esto?",
