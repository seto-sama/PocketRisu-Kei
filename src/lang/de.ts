...
export const languageGerman = {
    ...
    "errors": {
        ...
        "networkFetchWeb": "Dies kann ein CORS-Fehler sein. Dies geschieht nur bei Verwendung der Webversion aufgrund von Browserbeschränkungen. Versuchen Sie, die lokale Desktop-Version oder eine andere Version von PocketRisu Kei zu verwenden.",
    ...
    "setup": {
        ...
        "welcome": "Willkommen bei PocketRisu Kei! Ich bin Airisu und werde Sie durch die Einrichtung von PocketRisu Kei führen. Zuerst, wie darf ich Sie nennen?",
    ...
    "officialWikiDesc": "Offizielles Wiki für PocketRisu Kei. Schauen Sie doch gerne bei uns vorbei",
    "officialDiscord": "Offizieller Discord",
    "officialDiscordDesc": "Offizieller Discord zum Austausch über PocketRisu Kei",
    "persona": "Mein Profil",
    "icon": "Symbol",
    "account": "Konto",
    "remove": "Entfernen",
    ...
    "risupresetDesc": "Risupreset-Format ist ein Format, das speziell für PocketRisu Kei-Voreinstellungen entwickelt wurde.",
    "risuMDesc": "RisuM-Format ist ein Format, das speziell für PocketRisu Kei-Module entwickelt wurde.",
    ...
    "pluginRiskDetectedAlert": "PocketRisu Kei hat Code erkannt, der schädlich sein könnte und IHREN API-SCHLÜSSEL ODER PERSÖNLICHE DATEN STEHLEN KANN. Wir empfehlen Ihnen, DIESES PLUGIN NICHT ZU INSTALLIEREN.",
    "doNotInstall": "Nicht installieren",
    "continueAnyway": "Trotzdem fortfahren",
    "pluginNoRiskButAlert": "PocketRisu Kei hat keinen schädlichen Code erkannt, aber beachten Sie bitte, dass die Installation von Plugins aus nicht vertrauenswürdigen Quellen Sicherheitsrisiken bergen kann.",
