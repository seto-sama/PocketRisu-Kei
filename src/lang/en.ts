...
export const languageEnglish = {
    ...
    errors: {
        ...
        generationSetupInterrupted: "The previous generation setup was interrupted and will expire in about {{seconds}} seconds. Try rerolling again after that.",
        generationWorkflowBusy: "This room already has a generation waiting to finish or recover.",
    ...
    requestDiagnostics: {
        ...
        unavailable: "No request information",
        overview: "Overview",
        metadata: "Metadata",
        ...
        responseLimit: "Maximum response",
        model: "Model",
        ...
        timing: "Generation time",
        promptPreparation: "Preprocessing",
        memoryProcessing: "Hypa",
        responseGeneration: "Response generation",
        finalization: "Other",
        noRequestLog: "No persisted request log was found.",
        noRequestLogDesc: "The log may predate server-side request logging, or it may have been cleared.",
        unlinkedRequestLog: "This swipe has no linked request log.",
        unlinkedRequestLogDesc: "It was created before swipe-specific diagnostics metadata was recorded. No newer request log will be substituted.",
        requestLogLoadFailed: "The request log could not be loaded.",
        retry: "Retry",
        ...
        raw: "Raw",
        rawRemaining: "Raw remaining events",
    },
    help: helpEn,
    triggerCategories: {
        Special: "Special",
    ...
    inlayGallery: {
        ...
        inlayImageGallery: "Inlay Gallery",
        ...
        inlayFilter: "Filter",
        inlayFilterAll: "All",
        inlayFilterMetaMissing: "No Chat Link Information",
    ...
    mcpImport: {
        title: "Import MCP",
        description: "Choose an MCP included with Risu, or connect to another MCP server by entering its address.",
        source: "MCP",
        customSource: "Enter MCP address manually",
        address: "MCP address",
        addressPlaceholder: "https://example.com/mcp",
        alreadyImported: "This MCP is already imported.",
        builtIn: {
            aiAccess: "LLM Call",
            risuAccess: "Risu Access",
    ...
    chatVariablesEmpty: "The chat variable list is empty.",
    tokens: "Tokens",
    devToolTokens: {
        characterProfile: "Character Description",
        activeLorebook: "Active Character & Chat Lorebook",
        currentChat: "Current Chat",
        promptTemplate: "Prompt Template",
        loading: "Loading...",
        estimateNotice: "This is an estimate. The actual token count may be different.",
    },
    ...
    promptDiff: {
        ...
        onlyChanges: "Show changes only",
        context: "Context",
        name: "Name",
        type: "Type",
        emptyLine: "[empty line]",
        missingField: "No {field}",
        expandHiddenLines: "Expand hidden lines",
        linesAboveHidden: "… {count} lines above hidden (click to expand) …",
        linesSkipped: "… {count} lines hidden (click to expand) …",
        linesBelowHidden: "… {count} lines below hidden (click to expand) …",
        startOfPrompt: "Start of prompt",
        endOfPrompt: "End of prompt",
        modified: "Modified",
        added: "Added",
        removed: "Removed",
        unchanged: "Unchanged",
        ...
        unnamedPrompt: "{type} prompt",
    },
    devToolPreview: {
        request: "Preview Request Contents",
        active: "View Active Lorebooks",
        matches: "View Matched Lorebook Keywords",
        keyword: "Keyword",
        source: "Source",
    },
    ...
    value: "Value",
    reroll: "Regenerate",
    recoveringGenerationMessage: "This chat has an operation in progress.",
    ...
    convertCharacterToModuleConfirm: "Create a new module from character \"{}\"? The character description and first messages will be converted into lorebook entries.",
    convertModuleToCharacterConfirm: "Create a new character by copying the lorebook, scripts, assets, and other settings from module \"{}\"?",
    ...
    importCharacterAndPackage: "Import Character / Package",
    changeMessageRole: "Change Message Role",
    addInlayImageToAssets: "Add to Assets",
    addInlayImagePrompt: "Where would you like to add this inlay image?",
    inlayImageAddedToAssets: "The inlay image was added to the character.",
    ...
    accSectionChatPanel: "Chat Panel",
    accSectionInput: "Input",
    accSectionMenuBar: "Menu Bar",
    presets: "Presets",
    themePresets: "Theme Presets",
    imageGeneration: "Image Generation",
    imageGenerationRemainingQuota: "Remaining quota",
    imageGenerationQuotaHelp: "This is the remaining allowance for the usage limit introduced in NAI V5. The allowance replenishes a little every minute.",
    imageGenerationQuotaRemainingTime: "Time until fully recharged (estimated)",
    imageGenerationQuotaTimeUnavailable: "Recovery time is unavailable.",
    imageGenerationPreset: "Image Generation Preset",
    imageGenerationPresetNew: "New Image Preset",
    imageGenerationPresetDefault: "Default Image Preset",
    imageGenerationPresetName: "Preset Name",
    imageGenerationPresetInvalid: "This is not a valid image generation preset.",
    imageStylePreset: "Art Style Preset",
    ...
    imageStylePresetFolderView: "View by Folder",
    imageStylePresetTagView: "View by Tag",
    imageStylePresetModuleView: "View by Module",
    imageSettings: {
        steps: "Steps",
        cfgScale: "CFG Scale",
        width: "Width",
        ...
        vibeFile: "Vibe file",
        invalidVibeFile: "Invalid vibe file. Version must be 1.",
        vibeParseError: (error: unknown) => `Error parsing vibe file: ${error}`,
        vibePreview: "Vibe Preview",
        vibeModel: "Vibe Model",
        informationExtracted: "Information Extracted",
        referenceStrength: "Reference Strength Multiple",
        referenceType: "Reference Type",
        referenceCharacter: "Character Reference",
        referenceStyle: "Style Reference",
        referenceCharacterAndStyle: "Character & Style Reference",
        preciseReferenceStrength: "Strength",
        referenceFidelity: "Fidelity",
        characterReferenceImage: "Reference Image",
        useCharacterDefaultHint: "Leave blank to use the character's default image.",
        uploadImage: "Upload Image",
        uploadingImage: "Uploading Image...",
        imagePreview: "Image preview",
        varietyPlus: "Variety+",
        useLegacyUc: "Use legacy UC",
        enableI2i: "Enable I2I",
        i2iReferenceImage: "I2I Reference Image",
        strength: "Strength",
        noise: "Noise",
        workflow: "Workflow",
    ...
    key: "Key",
    noData: "No Data",
    noDisplayItems: "No items to display.",
    noSearchResults: "No search results",
    noSearchResultsDesc: "No results match the current search criteria.",
    noRegexScripts: "No Regex Scripts",
    noTriggerScripts: "No Trigger Scripts",
    noLorebook: "No Lorebook",
    noAssets: "No assets.",
    noCharacters: "No characters have been added.",
    autopilotScheduleEmpty: "The autopilot schedule is empty.",
    noMCP: "No MCPs Installed",
    ...
    confirmMessageDelete: "Confirm on Message Deletion",
    showPreviousChatSwipeButtons: "Show Previous Chat Swipe Buttons",
    textColor: "Text Color",
    classicRisu: "Classic Risu",
    highcontrast: "High-Contrast",
    requestretrys: "Request Retrys when Fail",
    outputRepetitionDetection: "Repetition Detection",
    ...
    moduleRegexLabel: "Regex",
    moduleTriggerLuaLabel: "Trigger/Lua",
    regexTarget: "Target",
    regexOutput: "Output Content",
    ...
    noAlternateGreetings: "No additional first messages have been configured.",
    ...
    personaManagement: "Management",
    personaExportEmpty: "The persona name or description is empty.",
    personaTagManagement: "Manage tags",
    personaSearch: "Search by name or note...",
    presetGeneral: "General",
    presetPromptProcessing: "Prompt Processing",
    presetSendPastChatsAsSystem: "Send Past Chats as System Role",
    presetToggleAndCustom: "Toggles & Customization",
    presetEnableJsonSchema: "Enable JSON Schema",
    presetRegexSearchPlaceholder: "Search regex scripts",
    presetLegacySettings: "Legacy Settings",
    ...
    ttsPreset: "TTS generation settings",
    ttsPresetDefault: "Default TTS settings",
    ttsPresetNew: "New TTS settings",
    ttsPresetBinding: "TTS generation settings binding",
    ttsProvider: "TTS provider",
    ttsAutoSpeech: "Auto Speech",
    ttsSettingsLink: "TTS settings",
    ttsApiKeyRequiredPrefix: "Enter an API key in ",
    ttsApiKeyRequiredSuffix: ".",
    ttsWebSpeechUnsupported: "Web Speech isn't supported in your browser or OS.",
    ttsVoiceAuto: "Auto",
    ttsVoiceUnset: "Unset",
    ttsWebSpeechPortabilityWarning: "Selecting a specific voice may not work after importing from another OS or browser.",
    ttsElevenLabsVoicesLoadError: "Failed to load ElevenLabs voices.",
    ttsSpeaker: "Speaker",
    ttsStyle: "Style",
    ttsSpeedScale: "Speed scale",
    ttsPitchScale: "Pitch scale",
    ttsVolumeScale: "Volume scale",
    ttsIntonationScale: "Intonation scale",
    ttsVolume: "Volume",
    ttsGptSoVitsServerUrl: "GPT-SoVITS server URL",
    ttsGptSoVitsServerUrlDescription: "GPT-SoVITS api_v2.py server (for example, http://127.0.0.1:9880)",
    ttsReferenceAudioPath: "Reference audio path",
    ttsGptSoVitsReferenceAudioPathDescription: "Path visible to the GPT-SoVITS server (3–10 seconds of reference audio recommended)",
    ttsTextLanguage: "Text language",
    ttsUseReferenceAudio: "Use reference audio",
    ttsReferenceAudioScript: "Reference audio script",
    ttsReferenceAudioLanguage: "Reference audio language",
    ttsTopP: "Top P",
    ttsTemperature: "Temperature",
    ttsSpeed: "Speed",
    ttsTopK: "Top K",
    ttsTextSplitMethod: "Text split method",
    ttsSynthesisModel: "Synthesis model",
    ttsVoiceModel: "Voice model",
    ttsNotSelected: "Not selected",
    ttsFishModelsLoadError: "Failed to load Fish Audio voice models.",
    ttsChunkLength: "Chunk length",
    ttsNormalize: "Normalize",
    ttsLanguageAuto: "Automatic language detection",
    ttsLanguageMultiMixed: "Multi-language mixed",
    ttsLanguageMultiMixedCantonese: "Multi-language mixed (Cantonese)",
    ttsLanguageEnglish: "English",
    ttsLanguageChineseEnglishMixed: "Chinese-English mixed",
    ttsLanguageJapaneseEnglishMixed: "Japanese-English mixed",
    ttsLanguageCantoneseEnglishMixed: "Cantonese-English mixed",
    ttsLanguageKoreanEnglishMixed: "Korean-English mixed",
    ttsLanguageChinese: "Chinese",
    ttsLanguageJapanese: "Japanese",
    ttsLanguageCantonese: "Cantonese",
    ttsLanguageKorean: "Korean",
    ttsSplitNone: "No splitting",
    ttsSplitFourSentences: "Split every 4 sentences",
    ttsSplitFiftyCharacters: "Split every 50 characters",
    ttsSplitChinesePeriods: "Split by Chinese periods",
    ttsSplitEnglishPeriods: "Split by English periods",
    ttsSplitPunctuation: "Split by various punctuation marks",
    ttsErrorPrefix: "TTS error",
    ttsApiKeyMissing: (provider: string) => `${provider} API key is not configured.`,
    ttsVoiceNotSelected: (provider: string) => `${provider} voice is not selected.`,
    ttsUrlNotConfigured: (provider: string) => `${provider} URL is not configured.`,
    ttsRequestFailed: (target: string, status: number) => `${target} request failed (${status}).`,
    ttsInvalidResponse: (target: string) => `${target} returned an invalid response.`,
    ttsGptSoVitsServerRequired: "The GPT-SoVITS server URL is required.",
    ttsGptSoVitsReferenceRequired: "A reference audio path is required when reference audio is enabled.",
    ttsElevenLabsVoicesTarget: "ElevenLabs voices",
    ttsVoicevoxSynthesisTarget: "VOICEVOX synthesis",
    ttsVoicevoxAudioQueryTarget: "VOICEVOX audio query",
    ttsVoicevoxSpeakersTarget: "VOICEVOX speakers",
    ttsFishModelsTarget: "Fish Audio models",
    ttsElevenLabsApiKey: "ElevenLabs API key",
    ttsVoicevoxUrl: "VOICEVOX URL",
    ttsVoicevoxUrlRequiredPrefix: "VOICEVOX runs on a local PC. Enter a valid engine URL in ",
    ttsVoicevoxUrlRequiredSuffix: " before selecting a speaker.",
    ttsVoicevoxLoadError: "Could not load VOICEVOX speakers. Check the engine URL and make sure VOICEVOX is running.",
    openAIApiKey: "OpenAI API key",
    novelAIApiKey: "NovelAI API key",
    openAICompatibleApiKey: "OpenAI Compatible API key",
    googleAIApiKey: "GoogleAI API key",
    ttsFishSpeechApiKey: "Fish Audio API key",
    ...
    chatInputPopupEditor: "Edit in popup editor",
    ...
    inlayImageCompression: "Compress Inlay Images When Saving",
    inlayImageSize: "Saved Size",
    inlayImageFormat: "File Format",
    inlayImageLossy: "Lossy Compression",
    inlayImageQuality: "Quality",
    originalSize: "Original Size",
    inlayCompressAll: "Compress All Inlay Images",
    inlayCompressAction: "Compress",
    inlayCompressing: "Compressing...",
    inlayCompressConfirm: "All inlay images will be re-saved using the current compression settings. This cannot be undone. Continue?",
    inlayCompressDone: "Compression complete",
    inlayCompressCount: " images compressed",
    inlaySizeChange: "size change",
    ...
    hideFolderOnRemoteAccess: "Hide this folder during remote access",
    showFolderOnRemoteAccess: "Show this folder during remote access",
    ...
    preloadChatImages: "Preload Images",
    ...
    promptTemplateWarnings: {
        title: "Prompt template warning",
        missing: (item: string) => `${item} is missing.`,
        multiple: (item: string) => `There are multiple ${item} entries. This may cause unexpected behavior.`,
        missingChatEnd: 'No Past Chats entry ends at "Until Chat End".',
        unconnectedChatRanges: (ranges: string) => `Past Chats ranges are not connected: [${ranges}]`,
    },
    ...
    imageGenerationPromptNotFound: "The generation prompt is not available for this image.",
    ...
    saveBackupForUpstreamConfirm: "This backup is intended for moving your data to the original RisuAI. Inlay images are excluded because their entry names use a layout that the original RisuAI cannot import. Other data (database, character assets, cold storage) is included.\n\nFor moving data between PocketRisu Kei installations, use the regular local backup instead.\n\nProceed?",
    ...
    moduleFolderManagement: "Manage module folders",
    moduleTagManagement: "Manage module tags",
    ...
    folderDisplayMode: "Display mode",
    folderModeIcon: "Icon",
    ...
    trashAutoDeleteSchedule: "Automatic deletion schedule",
    trashRetentionDaysSuffix: "days later",
    restore: "Restore",
    deletePermanently: "Delete permanently",
    trashEmpty: "The trash is empty.",
    emptyTrash: "Empty trash",
    emptyTrashConfirm: "Permanently delete all {count} characters in the trash? This cannot be undone.",
    emptyTrashConfirm2: "Are you really, really sure you want to empty the trash? The deleted characters cannot be recovered.",
    trashEmptied: "Permanently deleted {count} characters from the trash.",
    trashDesc: helpEn.trash,
    ...
    translationInputPlaceholder: "Enter text to translate",
    translationDialogClearAfterConfirm: "Clear after use",
    ...
    presetUntagged: "Untagged",
    presetNewFolder: "New folder",
    presetNewTag: "New tag",
    presetFolderNamePrompt: "Enter a folder name",
    presetTagNamePrompt: "Enter a tag name",
    presetFolderRenamePrompt: "Enter a new folder name",
    presetTagRenamePrompt: "Enter a new tag name",
    presetFolderDeleteConfirm: "Delete this folder? Presets in it will become uncategorized.",
    presetTagDeleteConfirm: "Delete this tag? It will be removed from assigned items.",
    presetFolderEmpty: "No presets in this folder",
    presetTagEmpty: "No items have this tag",
    presetItemDeletePrompt: 'What would you like to remove from "{}"?',
    presetRemoveTagAction: 'Remove the "{}" tag',
    presetRemoveAllTagsAction: "Remove all tags",
    presetDeleteAction: "Delete preset",
    bookmarkDeleteAction: "Delete bookmark",
    personaDeleteAction: "Delete persona",
    moduleDeleteAction: "Delete module",
    presetNoSearchResults: "No matching presets",
    chatSearch: "Search chats...",
    chatFolderDeleteConfirm: "Delete this folder? Chats in it will become uncategorized.",
    chatFolderEmpty: "No chats in this folder.",
    lorebookFolderEmpty: "No lorebooks in this folder.",
    chatNoSearchResults: "No matching chats",
    modelPresets: "Model Presets",
    modelPresetEmpty: "No model presets registered",
    modelPresetCreate: "Create new model preset",
    modelPresetRefreshAll: "Update all model preset profiles",
    modelPresetRefreshAllConfirm: "Update every saved model preset profile. Continue?",
    modelPresetRefreshAllSuccess: "Updated {count} model preset profiles.",
    modelPresetRefreshAllNone: "There are no model preset profiles that can be updated.",
    modelPresetRefreshAllSkipped: "Skipped {count} because their source profiles could not be found.",
    modelPresetRefreshAllSyncFailed: "The model catalog could not be synced, so saved profile data was used.",
    ...
    pluginModelProfileDescription: "Model registered by an enabled Plugin API 3.0 provider. The plugin must remain enabled to use this preset.",
    pluginModelUnavailable: "The Plugin API 3.0 model is unavailable. Make sure the provider plugin is installed and enabled.",
    ...
    profileModelReleaseDateLabel: "Model release date",
    profileDataCutoffLabel: "Data cutoff",
    profileUpdateConfirm: "Update to this profile?",
    profileReplaceWarn: "Settings incompatible with this profile will be kept inactive. Continue?",
    profileUpdateLossWarn: "The profile's settings structure may change. Continue?",
    ...
    unformatQuotes: "Enable Quote Formatting",
    ...
    globalCustomCSS: "Global Custom CSS",
    menu: "Menu",
    ...
    keepTranslation: "Keep Translation Link",
    generalSettings: "Language & Translation",
    languageSettingsSection: "Language & Display",
    translatorConfigurationSection: "Translator Configuration",
    translatorSettingsSection: "Translation Behavior",
    translationCache: "Translation Cache",
    translationCacheEntries: "Individual Translation Cache Search",
    translationCacheManagement: "Translation Cache Management",
    translationCacheManagementDesc: "Import, export, or clean up cached LLM translations stored on the server.",
    exportTranslationCacheDesc: "Save the current translation cache as a JSON file.",
    importTranslationCacheDesc: "Merge translations from a previously exported JSON cache file.",
    cleanupUnusedTranslationCacheDesc: "Delete only cache entries whose source text is no longer used by chats or summaries.",
    ...
    exportTranslationCacheEmpty: "No translation cache.",
    translationCacheEmptyDesc: "Translated chat messages are stored on the server and displayed here.",
    ...
    cleanupUnusedTranslationCache: "Clean Up Unused Translation Cache",
    cleanupUnusedTranslationCacheConfirm: "This cleans up translation cache entries whose source text no longer exists in current chats or HypaV3 summaries. Really clean up the translation cache?",
    cleanupUnusedTranslationCacheSuccess: (count: number) => `Cleaned up ${count} unused translation cache entries.`,
    cleanupUnusedTranslationCacheProgressScanningChats: "Scanning all chat originals...",
    cleanupUnusedTranslationCacheProgressLoadingCache: "Loading translation cache...",
    cleanupUnusedTranslationCacheProgressDeleting: (current: number, total: number) => `Deleting unused translation cache... (${current}/${total})`,
    invalidTranslationCacheFile: "Invalid translation cache file.",
    translationCacheSearchPlaceholder: "Search translation cache...",
    translationCacheShown: (shown: number, filtered: number, total: number) => `Showing ${shown} of ${total} total translation cache entries. (${filtered} search results total).`,
    translationCacheShownLoading: (shown: number, total: number) => `Showing ${shown} of ${total} total translation cache entries. (lazy-loading the rest...)`,
    deleteTranslationCacheEntryConfirm: "Delete this translation cache entry? This cannot be undone.",
    deleteTranslationCacheEntrySuccess: "Translation cache entry deleted.",
    translationCacheEntrySaved: "Translation cache updated.",
    ...
    autoTranslateLastOutputOnly: "Auto-translate Last Output Only",
    ...
    cumulativeActivity: "Cumulative Activity",
    reset: "Reset",
    ...
    hypaV3Settings: {
        ...
        memoryConfigurationLabel: "Memory Configuration",
        advancedSettingsLabel: "Advanced Settings",
        useExperimentalImplLabel: "Use Experimental Implementation",
        alwaysToggleOnLabel: "Always Enable",
        summarizationRequestsPerMinuteLabel: "Summarization Requests Per Minute",
        summarizationMaxConcurrentLabel: "Concurrent Summarization Requests",
        embeddingRequestsPerMinuteLabel: "Embedding Requests Per Minute",
        embeddingMaxConcurrentLabel: "Concurrent Embedding Requests",
        embeddingProviderLabel: "Embedding Provider",
        embeddingModelLabel: "Embedding Model",
        embeddingModelDescription: "The embedding model to use from the selected provider.",
        apiKeyListLabel: "API Key List",
        apiKeyDirectInputLabel: "Enter Key Directly",
        openAIKeyListDescription: "Select an OpenAI key saved in API Key Management.",
        voyageKeyListDescription: "Select a Voyage key saved in API Key Management.",
        customKeyListDescription: "Select a key saved in API Key Management.",
        keyPasswordLabel: "Key/Password",
        requestModelLabel: "Request Model",
        openAIAPIKeyLabel: "OpenAI API Key",
        voyageAPIKeyLabel: "Voyage API Key",
        urlLabel: "URL",
        presetRequiredError: "At least one preset is required.",
        invalidPresetError: "This is not a valid HypaMemory preset.",
    },
    hypaV3Modal: {
        titleLabel: "HypaV3",
        ...
        manualSummarizeSearchPlaceholder: "Search messages...",
        manualSummarizeGenerate: "Summarize",
        manualSummarizing: "Summarizing...",
        manualSummarizeResult: "Manual summarization result",
        manualSummarizeNoMessages: "No messages found",
        manualSummarizeNoMessageId: "This message has no message ID and cannot be selected.",
        manualSummarizeSelectedCount: "Selected messages: {0}",
        manualSummarizeSelectedMessages: "{0} messages selected",
        manualSummarizeSelectAtLeastOne: "Select at least one message.",
        reSummarize: "Re-summarize",
        reSummarizeSearchPlaceholder: "Search summaries...",
        reSummarizeSelectedCount: "Selected summaries: {0}",
        reSummarizeSelectedSummaries: "{0} summaries selected",
    ...
    disableGlobalLorebookRecursiveScanning: "Disable Global Lorebook Recursive Scanning",
    showTranslationLoading: "Show Translation Loading",
    copy: "Copy",
    paste: "Paste",
    depth: "Depth",
    returnCSSError: "Return CSS Error",
    pluginMemoryWarningTitle: "Plugin Data Loading",
    pluginMemoryWarningDescription: "Choose data to load for this session. The warning threshold is configurable in Laboratory; it is not a measured memory limit. Stored data is preserved.",
    pluginMemoryWarningDescriptionMobile: "Choose data to load this session. Turning items off preserves stored data.",
    pluginMemoryStoredData: "Stored plugin data",
    pluginStorageWarningThreshold: "Plugin data warning threshold",
    pluginMemoryStillToDisable: "Data above threshold",
    pluginMemorySelectedTotal: "Data selected to load: {}",
    pluginMemoryUnclassified: "Unclassified and legacy data",
    pluginMemoryUnclassifiedDescription: "Older data and V2/V2.1 storage without reliable ownership information.",
    pluginMemoryEnableAll: "Enable All",
    pluginMemoryDisableAll: "Disable All",
    pluginMemoryProceed: "Proceed",
    pluginMemoryDisabledForSession: "Disabled for this session by memory protection",
    pluginV2Blocked: "Legacy Plugin V2 blocked",
    ...
    soundAndDisplay: "Sound & Display",
    addons: "Add-ons",
    groupNotification: "Notifications",
    groupVolume: "Volume",
    browserNotification: "Browser notifications",
    groupMessageNotification: "Response-complete notification",
    groupTranslateNotification: "Translation-complete notification",
    ttsVoiceVolume: "TTS voice",
    ...
    showModuleSidebar: "Show Module Selection in Sidebar",
    disableMobileDragDrop: "Disable Character Drag & Drop on Mobile",
    disableToggleBinding: "Show Chat Toggle Binding in Sidebar",
    ...
    modelPresetCredentialHelp: "Select credentials from the API key list or enter them directly.",
    ...
    modelPresetAuthentication: "Authentication",
    modelPresetKeyPassword: "Key / Password",
    modelPresetRepetitionPenalty: "Repetition penalty",
    modelPresetStopSequences: "Stop Sequences",
    modelPresetConnectionGroup: "Connection",
    modelPresetParametersGroup: "Parameters",
    modelPresetFeaturesGroup: "Features",
    modelPresetCustomFlagsGroup: "Custom Flags",
    modelPresetControlsGroup: "Controls",
    modelPresetOtherGroup: "Other",
    modelPresetEchoMessage: "Echo Message",
    modelPresetEchoDelay: "Echo Delay (Seconds)",
    modelPresetPromptPresetFirst: "Prefer prompt preset",
    modelPresetPromptParamsFirst: "Prefer prompt parameters",
    modelPresetGlobalBinding: "Default model preset binding",
    modelPresetGlobalBindingHelp: "Used as the main model binding for new chats.",
    modelPresetGlobalSubBinding: "Default submodel preset binding",
    ...
    modelPresetOverwriteTitle: "Overwrite chat bindings",
    modelPresetBindingGroup: "Preset binding",
    modelPresetOverwriteDesc: "Apply the current defaults to every existing chat.",
    modelPresetOverwriteModelShort: "Overwrite model",
    modelPresetOverwriteSubmodelShort: "Overwrite submodel",
    modelPresetOverwriteConfirm: "Overwrite the selected model preset binding in every chat?",
    modelPresetOverwriteProgress: "Overwriting bindings...",
    modelPresetOverwriteSuccess: "Updated {count} chats",
    modelPresetDefaultMaxContext: "Default model preset context",
    modelPresetDefaultMaxResponse: "Default model preset response size",
    ...
    modelPresetGroupRegistry: "Registry",
    modelPresetGroupOther: "Other",
    profileVisibilityAll: "Show all",
    profileVisibilityHideDeprecated: "Hide deprecated",
    modelProviderFilter: "Provider filter",
    modelProviderFilterSummary: (shown: number, total: number) => `${shown} of ${total} providers shown`,
    modelProviderFilterConfigure: "Configure",
    modelProviderFilterDialogTitle: "Provider filter",
    modelProviderFilterDialogDescription: "Choose which models.dev providers appear in the official profile list. Echo and Plugin are always shown.",
    modelProviderFilterSearch: "Search providers",
    modelProviderFilterShowAll: "Show all",
    modelProviderFilterHideAll: "Hide all",
    modelProviderFilterSave: "Save",
    modelProviderFilterEmpty: "No models.dev providers are available yet. Sync the registry first.",
    modelProviderFilterNoMatch: "No providers match the search.",
    modelProviderFilterProfileCount: (count: number) => `${count} profiles`,
    registryRefresh: "Sync registry",
    registryRefreshHelp: "Re-download the latest model catalog from models.dev.",
    ...
    hotkeyToolbar: "Toolbar",
    hotkeyFeatures: "Features",
    hotkeyDesc: {
        reroll: "Reroll",
        ...
        settings: "Settings",
        home: "Home",
        presets: "Prompt Binding",
        persona: "Persona Binding",
        modelSelect: "Model Binding",
        toggleCSS: "Toggle CSS",
        prevChar: "Previous Character",
        nextChar: "Next Character",
        quickMenu: "Quick Menu",
        quickSettings: "Quick Settings",
        toggleSidebarView: "Toggle Chat/Character Sidebar",
        toggleLog: "Request Log",
    ...
    mcpAccessPrompt: (tool: string, action: string) =>
    ...
    bookmarkSearchPlaceholder: "Search bookmarks, characters, and chats...",
    bookmarkNoSearchResults: "No matching bookmarks",
    bookmarkTagNamePrompt: "Enter a bookmark tag name",
    bookmarkTagRenamePrompt: "Enter a new bookmark tag name",
    bookmarkTagDeleteConfirm: "Delete this tag? It will be removed from assigned bookmarks.",
    bookmarkTargetMissing: "The bookmarked message could not be found.",
    bookmarkOperationFailed: "The bookmark operation failed.",
    ...
    enableMessage: "Include in Context",
    ...
    disableAboveHelp: "Removes every message above this boundary from the context.",
    ...
    fetchLogConsent: (pluginName: string) => `Plugin ${pluginName} is requesting to fetch logs, which may expose sensitive information. Do you want to allow this?`,
    getFullDatabaseConsent: (pluginName: string) => `Plugin ${pluginName} is requesting to access the full database, which may expose sensitive information. Do you want to allow this?`,
    mainDomAccessConsent: (pluginName: string) => `Plugin ${pluginName} is requesting to access the main Document, which may expose sensitive information. Do you want to allow this?`,
    replacerPermissionConsent: (pluginName: string) => `Plugin ${pluginName} is requesting permission to replace content in the chat, which may be used to manipulate the conversation. Do you want to allow this?`,
    providerPermissionConsent: (pluginName: string) => `Plugin ${pluginName} is requesting permission to access the provider, which may allow it to make unauthorized API calls. Do you want to allow this?`,
    sendChatConsent: (pluginName: string) => `Plugin ${pluginName} is requesting permission to send chat messages on your behalf, which will trigger AI responses. Do you want to allow this?`,
    inlayPermissionConsent: (pluginName: string) => `Plugin ${pluginName} is requesting permission to access inlay assets, which may expose files attached to chats. Do you want to allow this?`,
    ...
    serverBackupRestoreMenuTitle: "Choose how to restore this backup",
    serverBackupLoadBackup: "Load backup",
    serverBackupRestoreAssets: "Restore assets",
    serverBackupAssetsRestoring: "Restoring missing assets from backup...",
    serverBackupAssetsRestoreSuccess: (restored: number, unavailable: number) =>
        unavailable > 0
            ? `Restored ${restored} missing assets. ${unavailable} referenced assets were not in this backup.`
            : `Restored ${restored} missing assets.`,
    ...
    unsupportedRemoteSave: "PocketRisu Kei does not process remote data. Disable 'Enable Remote Saving' in the Advanced Settings tab of the RisuAI installation you were using, then copy the save folder again.",
    blockquoteStyling: "Blockquote Styling",
    cornerBracketStyling: "Corner Brackets Styling",
    ...
    deviceList: "Devices",
    deviceListEmpty: "No devices are currently connected.",
    ...
    systemLogsDeleteEntry: "Delete",
    systemLogsDeleteConfirm: "Delete this log?",
    ...
    pluginStorageLocation: "Storage location",
    ...
    pluginStorageSearch: "Search key or value...",
    pluginStorageRefresh: "Refresh",
    pluginStorageEmpty: "No stored entries.",
    pluginStorageLoadError: "Failed to load storage.",
    popupEditorSave: "Save",
    popupEditorFormatJson: "Format JSON",
    popupEditorWordWrap: "Word wrap",
    popupEditorPreview: "Preview",
    popupEditorEdit: "Edit",
    popupEditorPreviewVariables: "Test CBS",
    popupEditorPreviewNoVariables: "This text does not contain any editable CBS.",
    popupEditorPreviewEmpty: "Nothing to preview.",
    popupEditorPreviewError: (msg: string) => `Preview failed: ${msg}`,
    cbsDocumentationMenu: "CBS syntax help",
    cbsDocumentationTitle: "CBS syntax help",
    cbsDocumentationSearchPlaceholder: "Search CBS documentation...",
    cbsDocumentationAliases: "Aliases:",
    cbsDocumentationEmpty: "No matching CBS documentation found.",
    popupEditorJsonError: (msg: string) => `JSON parse failed: ${msg}`,
    popupEditorDiscardConfirm: "Discard unsaved changes?",
    popupEditorReplace: "Replace",
    popupEditorReplaceAll: "Replace all",
    popupEditorPreviousMatch: "Previous match",
    popupEditorNextMatch: "Next match",
    popupEditorMatchCase: "Match case",
    popupEditorWholeWord: "Match whole word",
    popupEditorUseRegex: "Use regular expression",
    popupEditorToggleReplace: "Toggle replace",
    popupEditorSearchCount: (current: number, total: number) => `${current} of ${total}`,
    ...
    pluginStorageEmptyValue: "(empty)",
    pluginStorageDeleteConfirm: (key: string) => `Delete "${key}"?`,
    pluginStorageValuePreview: (preview: string) => `Value:\n${preview}`,
    pluginStorageBulkDeleteShown: "Delete shown",
    pluginStorageBulkDeleteAll: "Clear all",
    ...
    usage: "Usage",
    usageDesc: "Token and cache usage from LLM generation responses is stored separately.",
    ...
    usageCacheCreationTokens: "Cache creation",
    usageEstimatedCost: "Estimated cost",
    usageSearchPlaceholder: "Search model or provider",
    usageEmpty: "No usage has been recorded.",
    usageEmptyDesc: "Requests are recorded on the server and displayed here.",
    usageUnknownModel: "Unknown model",
    usageClearConfirm: "Delete all stored usage records? This cannot be undone.",
    usageDeleteConfirm: "Delete this usage record?",
    usageDateFilter: "Period",
    usagePeriodDay: "Last 24 hours",
    usagePeriodWeek: "Last 7 days",
    usagePeriodMonth: "Last 30 days",
    usagePeriodCustom: "Custom range",
    usageStartDate: "Start date",
    usageEndDate: "End date",
    usageChartTitle: "Token usage by period",
    usageEntries: "Individual usage records",
    ...
    storageRowHypaVectorCache: "HypaMemory vector cache",
    storageRowHypaVectorCacheDesc: "Cached embedding vectors generated from HypaMemory text. The source memory text remains in chat data.",
    storageRowLlmTranslationCache: "LLM translation cache",
    storageRowLlmTranslationCacheDesc: "Cached source and translated text used to avoid repeating LLM translation requests.",
    ...
    storageRowKvUncategorizedDesc: "Uncategorized save data and temporary database files such as the WAL.",
    ...
    storageOrphanWhen: "Deletion cannot be undone, so make a backup before cleaning.",
    ...
    storageOrphanAutoCleanDesc: "Automatically cleans up orphaned assets whenever you connect to the server.",
    ...
    storageHypaCleanup: "Clean up HypaMemory vector cache",
    ...
    storageHypaCleanupDone: (count: number, reclaimed: number) =>
        `Removed ${count} unused vectors (${(reclaimed / 1024 / 1024).toFixed(1)} MB).`,
    storageHypaCleanupNoop: "No unused HypaMemory vectors were found.",
    storageHypaCleanupFailed: "HypaMemory vector cleanup failed",

    storageBackups: "Backups",
    storageBackupsManage: "Manage backups",
    storageBackupsAuto: "Snapshot (DB only)",
    storageBackupsAutoDesc: "Fast recovery files that do not include character or inlay assets. They are managed automatically, and can also be created manually from Create backup above.",
    ...
    migrationCompatBackupExportButton: "Export compatible backup",
    migrationCompatSnapshotExportButton: "Export compatible snapshot",
    migrationCompatBackupImportButton: "Import compatible backup",
    migrationDatasetExportButton: "Export dataset",

    // System → Backups tab
    systemBackups: "Backups",
    backupTabDesc: "Manage snapshots, full backups, and local backups in one place.",
    backupCreateSection: "Backup management",
    backupCreateNow: "Back up now",

    backupSnapshot: "Snapshot (DB only)",
    backupSnapshotAutomatic: "Automatic snapshots",
    backupSnapshotManual: "Manual snapshots",
    backupSnapshotEmpty: "No snapshots.",
    backupSnapshotRestore: "Restore from this snapshot",
    backupSnapshotDelete: "Delete snapshot",
    backupNoteEdit: "Edit backup note",
    backupNoteDescription: "The note is stored separately from the backup data and remains after restoring an older backup. Leave it blank to remove it.",
    backupNotePlaceholder: "Add a short note",
    backupNoteEmpty: "No note",
    backupNoteRequired: "Enter a note.",
    backupNoteSaveFailed: "Failed to save backup note",
    backupCreateNoteDescription: "Leave the note blank to create it without a note.",
    backupCreatedAutomatically: "Created by automatic backup",
    backupSnapshotAutomaticEntry: "Automatic snapshot",
    backupSnapshotPromote: "Preserve as manual snapshot",
    backupSnapshotPromoteDescription: "Adding a note moves this rotating automatic snapshot to the manual snapshot list so it is kept until you delete it.",
    ...
    backupServerDesc: "A full backup including character assets and inlay images.",
    backupServerSummary: (count: number, bytes: number) =>
        `Current ${count} · ${(bytes / 1024 / 1024).toFixed(1)} MB on disk`,
    backupServerCreate: "Create server backup",
    backupServerEmpty: "No backups saved.",
    manualSnapshotCreate: "Create snapshot",
    manualSnapshotSaving: "Saving snapshot...",
    manualSnapshotSaveSuccess: (filename: string) => `Snapshot saved: ${filename}`,
    manualSnapshotEmpty: "No manual snapshots.",
    ...
    backupScheduleEnabled: "Automatic backup",
    backupScheduleServer: "Server backup",
    backupScheduleSnapshot: "Snapshot",
    backupScheduleDaysSuffix: "days",
    backupScheduleSuccess: "Backup schedule updated.",
    backupScheduleFailed: "Failed to update backup schedule",
    ...
    recentlyUploadedCharacters: "Recently Uploaded",
    relatedLinks: "Related Links",
    getMoreCharacters: "Search RisuRealm",
    realmMuteCharacter: "Mute character",
    realmMuteCreator: "Mute creator",
    realmMuteManagement: "Manage mutes",
    realmMutedCharacters: "Muted characters",
    realmMutedCreators: "Muted creators",
    realmMuteSearchPlaceholder: "Search mutes...",
    realmMuteEmpty: "No muted entries",
    realmMuteClearAll: "Clear all mutes",
    realmMuteClearAllConfirm: "Clear all character and creator mutes?",
    realmMuteEditNote: "Edit mute note",
    realmMuteNotePrompt: "Why was this muted? Leave blank to remove the note.",
    realmMuteNoNote: "No note",
    realmViewSuffix: "view",
    ...
    recentChatsSearchPlaceholder: "Search by character name...",
    noRecentChatsSearchResults: "No matching conversations",
    sidebarMenuAddDivider: "Add divider",
    sidebarMenuExitEdit: "Close sidebar menu editor",
    sidebarMenuRemoveDivider: "Remove divider",
    sidebarMenuHideIcon: "Hide icon",
    sidebarMenuShowIcon: "Show icon",
