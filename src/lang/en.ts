...
export const languageEnglish = {
    ...
    requestDiagnostics: {
        ...
        description: "Inspect generation usage, message metadata, the persisted request log, and prompt snapshot.",
        overview: "Overview",
        metadata: "Metadata",
        ...
        responseLimitDesc: "The response-token limit sent to the provider. This is not part of the request input or the actual number of generated tokens.",
        model: "Model",
