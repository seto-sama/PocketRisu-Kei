...
export const languageEnglish = {
    ...
    ttsVoicevoxUrlRequired: "VOICEVOX runs on a local PC. Enter a valid engine URL in TTS settings before selecting a speaker.",
    ...
    ttsHuggingFaceApiKey: "Hugging Face API key",
    ttsFishSpeechApiKey: "fish-speech API key",
