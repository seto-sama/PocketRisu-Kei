...
export const languageKorean = {
  ...
  errors: {
    ...
    generationSetupInterrupted:
      "이전 생성 준비 작업이 중단된 상태입니다. 해당 작업은 약 {{seconds}}초 후 만료됩니다. 그 후 다시 시도해 주세요.",
    generationWorkflowBusy:
      "이 채팅에는 완료 또는 복구를 기다리는 생성 작업이 있습니다.",
    ...
    requestLogRemoved: "리퀘스트 로그가 삭제되었습니다.",
    requestLogRemovedDesc:
      "리퀘스트 로그는 앱이 재시작되거나 새로고침되면 삭제됩니다.",
  ...
  requestDiagnostics: {
    ...
    finalization: "기타",
    noRequestLog: "저장된 리퀘스트 로그를 찾지 못했습니다.",
    noRequestLogDesc:
      "리퀘스트 로그가 삭제되었거나, 보존 기능이 추가되기 전의 응답입니다.",
    unlinkedRequestLog: "이 스와이프에 연결된 리퀘스트 로그가 없습니다.",
    unlinkedRequestLogDesc:
      "스와이프별 진단 메타데이터를 저장하기 전에 생성된 응답입니다. 더 최신 요청의 로그로 대체하지 않습니다.",
    requestLogLoadFailed: "리퀘스트 로그를 불러오지 못했습니다.",
    retry: "다시 시도",
    presetName: "프리셋 이름",
  ...
  mcpImport: {
    title: "MCP 가져오기",
    description:
      "Risu에 포함된 MCP를 선택하거나 주소를 직접 입력해 다른 MCP 서버에 연결합니다.",
    source: "MCP",
    customSource: "MCP 주소 직접 입력",
    address: "MCP 주소",
    addressPlaceholder: "https://example.com/mcp",
    alreadyImported: "이미 가져온 MCP입니다.",
    builtIn: {
      aiAccess: "LLM 호출",
      risuAccess: "Risu 접근",
  ...
  promptDiff: {
    ...
    defaultView: "기본",
    splitView: "좌우 분할",
    groupChanges: "수정 내역 묶기",
    onlyChanges: "변경 사항만 보기",
    context: "주변 줄",
    name: "이름",
    type: "타입",
    emptyLine: "[빈 줄]",
    missingField: "{field} 없음",
    expandHiddenLines: "숨겨진 줄 펼치기",
    linesAboveHidden: "… 위쪽 {count}줄 숨김 (눌러서 펼치기) …",
    linesSkipped: "… {count}줄 숨김 (눌러서 펼치기) …",
    linesBelowHidden: "… 아래쪽 {count}줄 숨김 (눌러서 펼치기) …",
    startOfPrompt: "프롬프트 시작",
    endOfPrompt: "프롬프트 끝",
    modified: "수정됨",
    added: "추가됨",
    removed: "삭제됨",
    unchanged: "변경 없음",
    changedBlocks: "변경된 블록",
    changeCount: "{count}개 변경",
    noBodyContent: "본문 없음",
    calculating: "비교 결과 계산 중...",
    noChanges: "변경 사항 없음",
    unnamedPrompt: "{type} 프롬프트",
  },
  devToolPreview: {
    request: "요청 내용 미리보기",
    active: "활성화된 로어북 보기",
    matches: "매칭된 로어북 키워드 보기",
    keyword: "키워드",
    source: "출처",
  },
  ...
  addInlayImageToAssets: "에셋에 넣기",
  addInlayImagePrompt: "이 인레이 이미지를 어디에 추가하시겠습니까?",
  inlayImageAddedToAssets: "인레이 이미지를 캐릭터에 추가했습니다.",
  translator: "번역기",
  disabled: "비활성화됨",
  ...
  imageGenerationPresetName: "세팅 이름",
  imageGenerationPresetInvalid: "올바른 이미지 생성 세팅값이 아닙니다.",
  imageStylePreset: "그림체 프리셋",
  ...
  imageStylePresetFolderView: "폴더별 보기",
  imageStylePresetTagView: "태그별 보기",
  imageStylePresetModuleView: "모듈별 보기",
  imageSettings: {
    steps: "스텝",
    cfgScale: "CFG 스케일",
    width: "너비",
  ...
  outputRepetitionDetection: "반복 루프 감지",
  utilityBot: "유틸리티 봇",
  ShowLog: "리퀘스트 로그 보기",
  ...
  moduleRegexLabel: "정규식",
  moduleTriggerLuaLabel: "트리거/Lua",
  regexTarget: "대상",
  regexOutput: "출력 형식",
  scriptType: "스크립트 타입",
  type: "타입",
  ...
  noAlternateGreetings: "설정된 추가 첫 메시지가 없습니다.",
  unrecommended: "비권장",
  chatNotes: "채팅 노트",
  ...
  newPersona: "새 페르소나",
  personaManagement: "관리",
  personaExportEmpty: "페르소나 이름 또는 설명이 비어 있습니다.",
  personaTagManagement: "태그 관리",
  ...
  ttsSettings: "TTS 설정",
  ttsPreset: "TTS 생성 설정",
  ttsPresetDefault: "기본 TTS 설정",
  ttsPresetNew: "새 TTS 설정",
  ttsPresetBinding: "TTS 생성 설정 바인딩",
  ttsProvider: "TTS 공급자",
  ttsAutoSpeech: "자동 음성 재생",
  ttsSettingsLink: "TTS 설정",
  ttsApiKeyRequiredPrefix: "",
  ttsApiKeyRequiredSuffix: "에서 API 키를 입력하세요.",
  ttsWebSpeechUnsupported: "이 브라우저 또는 운영체제에서는 Web Speech를 지원하지 않습니다.",
  ttsVoiceAuto: "자동",
  ttsVoiceUnset: "설정 안 함",
  ttsWebSpeechPortabilityWarning: "특정 음성을 선택하면 다른 운영체제나 브라우저에서 가져왔을 때 정상적으로 작동하지 않을 수 있습니다.",
  ttsElevenLabsVoicesLoadError: "ElevenLabs 음성 목록을 불러오지 못했습니다.",
  ttsSpeaker: "화자",
  ttsStyle: "스타일",
  ttsSpeedScale: "속도 배율",
  ttsPitchScale: "음높이 배율",
  ttsVolumeScale: "음량 배율",
  ttsIntonationScale: "억양 배율",
  ttsVolume: "음량",
  ttsGptSoVitsServerUrl: "GPT-SoVITS 서버 주소",
  ttsGptSoVitsServerUrlDescription: "GPT-SoVITS api_v2.py 서버 주소 (예: http://127.0.0.1:9880)",
  ttsReferenceAudioPath: "참조 오디오 경로",
  ttsGptSoVitsReferenceAudioPathDescription: "GPT-SoVITS 서버에서 접근할 수 있는 경로 (3~10초 길이의 참조 오디오 권장)",
  ttsTextLanguage: "텍스트 언어",
  ttsUseReferenceAudio: "참조 오디오 사용",
  ttsReferenceAudioScript: "참조 오디오 대본",
  ttsReferenceAudioLanguage: "참조 오디오 언어",
  ttsTopP: "Top P",
  ttsTemperature: "온도",
  ttsSpeed: "속도",
  ttsTopK: "Top K",
  ttsTextSplitMethod: "텍스트 분할 방식",
  ttsSynthesisModel: "합성 모델",
  ttsVoiceModel: "음성 모델",
  ttsNotSelected: "선택하지 않음",
  ttsFishModelsLoadError: "Fish Audio 음성 모델 목록을 불러오지 못했습니다.",
  ttsChunkLength: "청크 길이",
  ttsNormalize: "정규화",
  ttsLanguageAuto: "언어 자동 감지",
  ttsLanguageMultiMixed: "다국어 혼합",
  ttsLanguageMultiMixedCantonese: "다국어 혼합 (광둥어)",
  ttsLanguageEnglish: "영어",
  ttsLanguageChineseEnglishMixed: "중국어-영어 혼합",
  ttsLanguageJapaneseEnglishMixed: "일본어-영어 혼합",
  ttsLanguageCantoneseEnglishMixed: "광둥어-영어 혼합",
  ttsLanguageKoreanEnglishMixed: "한국어-영어 혼합",
  ttsLanguageChinese: "중국어",
  ttsLanguageJapanese: "일본어",
  ttsLanguageCantonese: "광둥어",
  ttsLanguageKorean: "한국어",
  ttsSplitNone: "분할하지 않음",
  ttsSplitFourSentences: "4문장마다 분할",
  ttsSplitFiftyCharacters: "50자마다 분할",
  ttsSplitChinesePeriods: "중국어 마침표 기준 분할",
  ttsSplitEnglishPeriods: "영어 마침표 기준 분할",
  ttsSplitPunctuation: "문장 부호 기준 분할",
  ttsErrorPrefix: "TTS 오류",
  ttsApiKeyMissing: (provider: string) => `${provider} API 키가 설정되지 않았습니다.`,
  ttsVoiceNotSelected: (provider: string) => `${provider} 음성을 선택하지 않았습니다.`,
  ttsUrlNotConfigured: (provider: string) => `${provider} URL이 설정되지 않았습니다.`,
  ttsRequestFailed: (target: string, status: number) => `${target} 요청에 실패했습니다 (${status}).`,
  ttsInvalidResponse: (target: string) => `${target}에서 올바르지 않은 응답을 반환했습니다.`,
  ttsGptSoVitsServerRequired: "GPT-SoVITS 서버 주소를 설정해야 합니다.",
  ttsGptSoVitsReferenceRequired: "참조 오디오를 사용하려면 참조 오디오 경로를 설정해야 합니다.",
  ttsElevenLabsVoicesTarget: "ElevenLabs 음성 목록",
  ttsVoicevoxSynthesisTarget: "VOICEVOX 음성 합성",
  ttsVoicevoxAudioQueryTarget: "VOICEVOX 오디오 쿼리",
  ttsVoicevoxSpeakersTarget: "VOICEVOX 화자 목록",
  ttsFishModelsTarget: "Fish Audio 모델 목록",
  ttsElevenLabsApiKey: "ElevenLabs API key",
  ttsVoicevoxUrl: "VOICEVOX URL",
  ttsVoicevoxUrlRequiredPrefix: "VOICEVOX는 로컬 PC에서 실행되므로 ",
  ttsVoicevoxUrlRequiredSuffix: "에 올바른 엔진 URL을 입력해야 합니다.",
  ttsVoicevoxLoadError:
    "VOICEVOX 화자 목록을 불러오지 못했습니다. 엔진 URL과 VOICEVOX 실행 상태를 확인해 주세요.",
  ...
  fixedChatTextarea: "스크롤 중 채팅 입력창 고정",
  ...
  useAdditionalAssetsPreview: "에셋 미리보기 사용",
  ...
  inlayImageCompression: "인레이 이미지를 압축해서 저장",
  inlayImageSize: "저장 크기",
  inlayImageFormat: "확장자",
  inlayImageLossy: "손실 압축",
  inlayImageQuality: "품질",
  originalSize: "원본 크기",
  inlayCompressAll: "전체 인레이 이미지 압축",
  inlayCompressAction: "압축하기",
  inlayCompressing: "압축 중...",
  inlayCompressConfirm:
    "모든 인레이 이미지를 현재 압축 설정으로 다시 저장합니다. 되돌릴 수 없습니다. 계속하시겠습니까?",
  inlayCompressDone: "압축 완료",
  inlayCompressCount: "개 이미지 압축",
  inlaySizeChange: "용량 변화",
  ...
  translationDialogClearAfterConfirm: "작업 후 비우기",
  ...
  presetUntagged: "태그 없음",
  presetNewFolder: "새 폴더",
  presetNewTag: "새 태그",
  presetFolderNamePrompt: "폴더 이름을 입력하세요",
  presetTagNamePrompt: "태그 이름을 입력하세요",
  presetFolderRenamePrompt: "새 폴더 이름을 입력하세요",
  presetTagRenamePrompt: "새 태그 이름을 입력하세요",
  presetFolderDeleteConfirm: "이 폴더를 삭제하시겠습니까? 폴더 안의 프리셋은 미분류로 이동합니다.",
  presetTagDeleteConfirm: "이 태그를 삭제하시겠습니까? 지정된 항목에서 태그가 제거됩니다.",
  presetFolderEmpty: "이 폴더에 프리셋이 없습니다",
  presetTagEmpty: "이 태그가 지정된 항목이 없습니다",
  presetItemDeletePrompt: '프리셋 또는 태그를 삭제할까요?',
  presetRemoveTagAction: '\'{}\' 태그 제거',
  presetRemoveAllTagsAction: "모든 태그 제거",
  presetDeleteAction: "프리셋 삭제",
  bookmarkDeleteAction: "북마크 삭제",
  personaDeleteAction: "페르소나 삭제",
  moduleDeleteAction: "모듈 삭제",
  ...
  autoTranslateLastOutputOnly: "마지막 아웃풋만 자동 번역",
  notification: "알림",
  ...
  hypaV3Modal: {
    ...
    reSummarize: "재요약",
    reSummarizeSearchPlaceholder: "요약 검색...",
    reSummarizeSelectedCount: "선택한 요약: {0}",
    reSummarizeSelectedSummaries: "{0} 요약 선택됨",
    reSummarizing: "재요약 중...",
  ...
  addons: "부가 기능",
  groupNotification: "알림",
  groupVolume: "볼륨",
  browserNotification: "브라우저 알림",
  groupMessageNotification: "응답 완료 알림",
  groupTranslateNotification: "번역 완료 알림",
  ttsVoiceVolume: "TTS 음성",
  selectNotificationSound: "알림 소리 선택",
  uploadSound: "직접 업로드",
  uploadedSound: "업로드한 소리",
  soundSilent: "무음",
  soundDefault: "기본음",
  showModelInSidebar: "모델 프리셋 바인딩 활성화",
  showPresetInSidebar: "프롬프트 프리셋 바인딩 활성화",
  showPersonaInSidebar: "페르소나 바인딩 활성화",
  showModuleSidebar: "모듈 선택 버튼 표시",
  disableMobileDragDrop: "모바일에서 캐릭터 드래그 앤 드롭 비활성화",
  disableToggleBinding: "채팅 토글 바인딩 활성화",
  ...
  action: "동작",
  hotkey: "단축키",
  hotkeyChatInput: "채팅 입력창",
  hotkeyToolbar: "메시지 툴바",
  hotkeyFeatures: "기능",
  hotkeyDesc: {
    reroll: "재생성",
    unreroll: "재생성 취소",
    ...
    quickMenu: "빠른 메뉴",
    quickSettings: "빠른 설정",
    toggleSidebarView: "챗/캐릭터 사이드바 전환",
    toggleLog: "리퀘스트 로그",
  ...
  bookmarkTagNamePrompt: "북마크 태그 이름을 입력하세요",
  bookmarkTagRenamePrompt: "새 북마크 태그 이름을 입력하세요",
  bookmarkTagDeleteConfirm:
    "이 태그를 삭제하시겠습니까? 지정된 북마크에서 태그가 제거됩니다.",
  ...
  disableMessage: "컨텍스트에서 제거",
  enableMessage: "컨텍스트에 포함",
  disableFirstMessageConfirm: "퍼스널 메세지를 비활성화할까요? 컨텍스트에서 제외됩니다.",
  disableAbove: "기억 한계선 긋기",
  disableAboveHelp: "해당 선 위의 모든 메시지를 컨텍스트에서 제거합니다.",
  bookmark: "북마크",
  branch: "분기 생성",
  fetchLogConsent:
  ...
  popupEditorPreview: "미리보기",
  popupEditorEdit: "편집하기",
  popupEditorPreviewVariables: "CBS 테스트하기",
  popupEditorPreviewNoVariables: "변경할 수 있는 CBS가 포함되어 있지 않습니다.",
  popupEditorPreviewEmpty: "미리보기할 내용이 없습니다.",
  popupEditorPreviewError: (msg: string) => `미리보기 실패: ${msg}`,
  cbsDocumentationMenu: "CBS 도움말",
  cbsDocumentationTitle: "CBS 도움말",
  cbsDocumentationSearchPlaceholder: "이름, 별칭 또는 설명으로 검색...",
  cbsDocumentationAliases: "별칭:",
  cbsDocumentationEmpty: "일치하는 CBS 문서가 없습니다.",
  ...
  storageOrphanWhen:
    "삭제 후에는 복구할 수 없으므로 백업 후 정리를 실행하세요.",
  ...
  backupNoteEdit: "백업 메모 수정",
  backupNoteDescription:
    "백업 파일 식별용 메모를 삽입할 수 있습니다. 입력칸을 비운 후 저장하면 메모가 삭제됩니다.",
  backupNotePlaceholder: "짧은 메모 입력",
  backupNoteEmpty: "메모 없음",
  backupNoteRequired: "메모를 입력해 주세요.",
  backupNoteSaveFailed: "백업 메모 저장 실패",
  backupCreateNoteDescription: "메모를 비워두면 메모 없이 생성됩니다.",
  backupCreatedAutomatically: "자동 백업으로 생성됨",
  backupSnapshotAutomaticEntry: "자동 스냅샷",
  backupSnapshotPromote: "수동 스냅샷으로 보관",
  backupSnapshotPromoteDescription:
    "메모를 추가하면 회전되는 자동 스냅샷을 수동 스냅샷 목록으로 옮겨 직접 삭제할 때까지 보관합니다.",
  ...
  relatedLinks: "주요 링크",
  getMoreCharacters: "RisuRealm 검색",
  realmMuteCharacter: "캐릭터 뮤트",
  realmMuteCreator: "제작자 뮤트",
  realmMuteManagement: "뮤트 관리",
  realmMutedCharacters: "캐릭터 뮤트",
  realmMutedCreators: "제작자 뮤트",
  realmMuteSearchPlaceholder: "뮤트 목록 검색...",
  realmMuteEmpty: "뮤트한 항목이 없습니다.",
  realmMuteClearAll: "모든 뮤트 해제",
  realmMuteClearAllConfirm: "캐릭터 및 제작자 뮤트를 모두 해제할까요?",
  realmMuteEditNote: "뮤트 메모 수정",
  realmMuteNotePrompt: "뮤트한 이유를 입력하세요. 빈 값으로 저장하면 메모만 삭제됩니다.",
  realmMuteNoNote: "메모 없음",
  realmViewSuffix: "보기",
