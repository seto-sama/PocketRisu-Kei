...
export const FOLDER_ICONS: Record<string, Component<IconProps>> = {
...
export function folderIconComponent(name: string | undefined): Component<IconProps> | undefined {
    return name && name !== 'folder' ? FOLDER_ICONS[name] : undefined
}
