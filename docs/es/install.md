...
| **Disco**   | 1 GB                    | 2+ GB                                    |
| **Node.js** | 24.15+                  | (no requerido para portable/Docker)      |
...
Obtén el archivo para tu OS desde la [página de Releases](https://github.com/seto-sama/PocketRisu-Kei/releases).
...
Se requiere Node.js 24.15 o superior:
