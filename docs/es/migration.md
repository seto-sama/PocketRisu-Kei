...
Hay dos formas de migrar datos desde una instalación existente de RisuAI (RisuAI Web, RisuAI Local) a PocketRisu. Elija según su entorno de origen y el tamaño de los datos.
...
- [2. Copia directa de la carpeta save](#2-copia-directa-de-la-carpeta-save) — RisuAI Local, datos grandes.
...
## 2. Copia directa de la carpeta save
...
4. Después de verificar la migración, archive o elimine manualmente los archivos hex originales si lo desea.
...
| Migrar desde RisuAI Local, datos grandes (10GB+)                | 2. Copia directa de la carpeta save      |
